...
import 'package:js_widget_runtime/src/flame_3d_vendor/src/graphics/backend/flutter_gpu/gpu_backend.dart'
    if (dart.library.js_interop) 'package:js_widget_runtime/src/flame_3d_vendor/src/graphics/backend/web_gpu/gpu_backend.dart'
    as backend;
